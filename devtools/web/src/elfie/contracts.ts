...
export const turnSchema = z.object({
  turn_id: z.string(), timestamp: z.string(), food_key: z.string().optional(), stimulus_bundle: z.object({ source_domain: z.enum(["communication", "embodied", "activity"]).default("communication"), message: z.string().default("") }).passthrough(),
  result: resultSchema,
  decision: z.object({

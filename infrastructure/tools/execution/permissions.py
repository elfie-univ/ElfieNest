...
logger = logging.getLogger("infrastructure.tools.permissions")
...
class PermissionManager:
    ...
    def __init__(self, config: Any, observation_port: ToolObservationPort) -> None:
        self.config = config
    ...
    def _record_decision(
        ...
        self._observation_port.record_permission_observation(
            PermissionDecisionObservation(
                action=action,
                resource=resource,
                allowed=allowed,

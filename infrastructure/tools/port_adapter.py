...
from .config import enabled_tool_keys, load_tool_configs
...
from .executor import (
    ToolResult as TechnicalToolResult,
)
from .local_files import LocalFileAccessPlugin
from .observation import ToolObservationPort
from .permissions import PermissionManager as ConcretePermissionManager
from .search import WebSearchPlugin
...
class ToolPortAdapter:
    ...
    def _executor(self, context: ToolExecutionContext):

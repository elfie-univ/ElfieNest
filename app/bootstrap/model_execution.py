"""Production composition for model execution used by cognition."""
...
from app.bootstrap.model_execution_food import final_main_food_loader
...
class ModelExecutionServices:
    """Model-execution objects assembled at the composition root."""
...
def build_model_execution_services(
    ...
    *,
    ...
    """Construct model execution without starting a background thread."""
    if db_path != ":memory:":
        get_token_tracker(
...
__all__ = ("ModelExecutionServices", "build_model_execution_services")

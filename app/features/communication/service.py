...
class CommunicationFacade:
    ...
    def list_conversations(
        ...
        try:
            ...
            raise CommunicationUnavailable("Conversation directory unavailable") from error
    ...
    def list_messages(
        ...
        try:
            ...
            raise CommunicationUnavailable("Conversation history unavailable") from error
    ...
    def record_prepared_user_message(
        ...
        try:
            ...
            raise CommunicationUnavailable("Unable to record conversation message") from error
...
def _message_result(
    elfie_id: str, stored: StoredConversationMessage
) -> MessageResult:

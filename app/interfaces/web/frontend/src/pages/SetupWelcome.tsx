...
const houseRoofDrawPath = "M 247.74802,119.80303 136.08694,27.333702 24.425861,122.12931"
const houseBodyDrawPath = "M 24.425861,122.12931 52.341131,98.285013 53.504266,237.27979 220.99589,236.69822 224.4853,100.02972 201.80414,80.837968"
...
export function SetupWelcome({ action, onContinue, title }: SetupWelcomeProps) {
  return (
    <section aria-labelledby="setup-welcome-title" className="setup-welcome">
        ...
        <div className="setup-welcome__stage">
          <svg className="setup-welcome__svg" viewBox={houseViewBox}>
            ...
            <g className="setup-welcome__radar-rings" data-testid="setup-welcome-radar-rings">
              <circle cx={radarCenter.x} cy={radarCenter.y} r="3.6" />
            </g>
            ...
            <g className="setup-welcome__ground-ripples" clipPath="url(#setup-welcome-house-interior)" data-testid="setup-welcome-ground-ripples">
              <ellipse cx="137.8" cy="231.2" rx="5.8" ry="2.4" />
              <ellipse cx="137.8" cy="231.2" rx="5.8" ry="2.4" />
              <ellipse cx="137.8" cy="231.2" rx="5.8" ry="2.4" />
            </g>

            <g className="setup-welcome__beam" data-testid="setup-welcome-beam">
              <path className="setup-welcome__beam-glow" d="M208.4 44.2C199 91 169 177 137.8 231.2" pathLength="1" />
              <path className="setup-welcome__beam-line" d="M208.4 44.2C199 91 169 177 137.8 231.2" pathLength="1" />
              <circle className="setup-welcome__beam-dot" cx="137.8" cy="231.2" r="2.9" />
            </g>
          </svg>
      ...
      <div className="setup-welcome__copy">
        <h1 className="setup-welcome__title" id="setup-welcome-title">{title}</h1>
        <Button className="setup-welcome__action" onClick={onContinue} size="lg" type="button">{action}</Button>
      </div>
    </section>
  )
}

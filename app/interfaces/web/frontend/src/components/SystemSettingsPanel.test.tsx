...
describe("SystemSettingsPanel", () => {
  beforeEach(() => {
    ...
    vi.mocked(useToolsPermissions).mockReturnValue({
      ...
      error: null,
      expanded: [],
      permissionDrafts: { WEB_SEARCH: "allow", READ: "allow" },
      permissionErrors: { WEB_SEARCH: null, READ: null },
      policy: { tool_permissions: { WEB_SEARCH: { mode: "allow", reason: "" }, READ: { mode: "allow", reason: "" } } },
      savePermission: vi.fn(async () => undefined),

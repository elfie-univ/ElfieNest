export const manage = {
  ...
  providerModels: {
    ...
    labels: { available: "可用", list: "{{name}} 模型列表", neverVerified: "未验证", reasoning: "推理", title: "{{name}} 的模型", tools: "工具", unavailable: "不可用", vision: "视觉" },
  ...
  foodPackages: {
    actions: { add: "添加粮食", archive: "归档", applyUpdate: "应用更新", cancel: "取消", delete: "删除", edit: "编辑", enable: "启用", disable: "停用", generate: "自动更新", generatePreview: "生成预览", generating: "生成中…", more: "操作", refresh: "重新读取", restore: "恢复", save: "保存", saveCreate: "保存创建", saving: "保存中…" },
  ...
  runtimeMonitor: {
    ...
    events: { beds: "{{count}} 个精灵尚未分配床位", empty: "暂无需要处理的事项", latest: "运行事件：{{subject}}", noServices: "尚未配置模型服务", ollama: "本地 Ollama 未正常运行", pendingTitle: "待处理", providerFailed: "{{name}} 连接失败", providerUnverified: "{{name}} 尚未验证", recentTitle: "最近事件" },

...
from elfie.brain.reasoning.decision_types import DecisionPlan
...
def reasoning_timeout_outcome(plan: DecisionPlan) -> TurnOutcome:
    ...
    return TurnOutcome(
        ...
        fallback_reason="reasoning_hard_timeout",

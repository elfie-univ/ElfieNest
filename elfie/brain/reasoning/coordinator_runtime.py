...
from elfie.brain.reasoning.coordinator_types import ControlMessage, StopControl
...
class CoordinatorRuntime:
    """Own the coordinator thread, mailbox, and reasoning worker lifecycle."""
...
class TurnOutcomeBuffer:
    ...
    def __init__(
        ...
        *,
        capacity: int = 256,
        on_record: Callable[[TurnOutcome], None] | None = None,
    ) -> None:

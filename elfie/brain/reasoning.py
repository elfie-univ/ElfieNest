...
if TYPE_CHECKING:
    from elfie.brain.cortical_worker import CorticalTaskView
...
class ReasoningRun:
    """Run a bounded cognitive loop for one already-admitted cortical task."""
    ...
    @staticmethod
    def _tool_request(task: CorticalTaskView, marker: _ToolMarker) -> ToolRequest:

...
class ModelContextCompiler:
    ...
    def _compile_event(
        ...
        if isinstance(payload, PhysicalPayload):  # noqa: IF_VARIANT_OK
            label = f"physical:{payload.modality.value}"
            channel_id = None
            content = payload.content
        elif isinstance(payload, SocialPayload):  # noqa: IF_VARIANT_OK
            label = "social:message"
            channel_id = payload.channel_id
            content = payload.content
        elif isinstance(payload, ExecutionPayload):  # noqa: IF_VARIANT_OK
            ...
            raise TypeError(  # noqa: GENERIC_ERR_OK
                "unsupported typed perception payload"
            )

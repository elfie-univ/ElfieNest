...
class NeocortexBrain:
    ...
    def think_and_decide(
        ...
        # 1. 评估预测加工误差
        pred_error = self.expectation.update_and_calculate_error(context.sensors)
        ...
        if active_network == "SN":
            ...
            user_msg = context.sensors.user_message

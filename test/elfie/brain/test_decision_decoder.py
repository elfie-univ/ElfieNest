...
from elfie.brain.decision_types import CancelPolicy, DecisionPlan
from elfie.brain.runtime_port import (
    ModelGenerationCapabilities,
    ModelGenerationResult,
    StructuredOutputMode,
)
from elfie.brain.turn_outcome import ModelMode, TerminalStatus
...
def test_decode_report_carries_timeout_and_error_into_turn_outcome() -> None:
    ...
    assert timeout.timeout_reason == "cortical_hard_timeout"

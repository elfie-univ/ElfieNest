"""Lifecycle and serialization tests for the per-Elfie reasoning worker."""
...
from elfie.brain.reasoning.worker import (
    ReasoningTask,
    ReasoningWorker,
    WorkerCapacityError,
...
def _task(turn_id: str) -> ReasoningTask:

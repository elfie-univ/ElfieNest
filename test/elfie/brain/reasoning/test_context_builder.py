"""Contract tests for strict reasoning-context assembly."""
...
def _homeostasis() -> EnergySnapshot:
...
def test_assemble_returns_immutable_brain_context_when_inputs_are_typed() -> None:
    ...
    # When: the context builder assembles the reasoning input.

...
from infrastructure.godot.artifacts import species_package_validation
from infrastructure.godot.artifacts import species_runtime_catalog


def test_source_species_gate_joins_config_and_godot_ids(monkeypatch: pytest.MonkeyPatch) -> None:
    class Completed:
        returncode = 0
...
def test_runtime_catalog_accepts_only_a_matching_validated_export_manifest(
    ...
    catalog = type("Catalog", (), {
        "digest": "digest",
        "definitions": (
            type("Definition", (), {"godot_package_id": "fox", "resolvable": True})(),
            type("Definition", (), {"godot_package_id": "dog", "resolvable": True})(),
        ),
    })()

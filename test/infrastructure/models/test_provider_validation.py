...
def test_discovers_ollama_models(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "infrastructure.models.provider_validation.open_provider_request",
...
def test_discovers_openai_compatible_models_with_bearer_header(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "infrastructure.models.provider_validation.open_provider_request", fake_urlopen
    )
...
def test_model_discovery_failure_becomes_check_result(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "infrastructure.models.provider_validation.open_provider_request", fail
    )
...
def test_discovery_uses_manual_models_when_models_endpoint_is_unavailable(
    ...
    monkeypatch.setattr(
        "infrastructure.models.provider_validation.open_provider_request", unsupported
    )

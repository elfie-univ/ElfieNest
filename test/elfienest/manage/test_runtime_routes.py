...
def client(
    ...
    with (
        ...
        patch("elfienest.manage.runtime_routes._RUNTIME_CONFIG_PATH", runtime_config_path),
        patch("elfienest.manage.runtime_routes.get_runtime_observer", return_value=runtime_observer),
        patch("elfienest.manage.runtime_routes.get_token_tracker", return_value=token_tracker),
    ):

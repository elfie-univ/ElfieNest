...
from elfienest.cli.tui.config_editors import config_llm
...
def test_config_llm_stops_cleanly_when_model_input_hits_eof(
    ...
    monkeypatch.setattr("elfienest.cli.tui.config_editors.clear_screen", lambda: None)
    monkeypatch.setattr("elfienest.cli.tui.config_editors.print_banner", lambda: None)

...
def test_regenerate_removes_models_deleted_from_provider(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "runtime.validation.overview.ProviderValidationRunner.verify_provider",
    ...
    monkeypatch.setattr(
        "runtime.validation.overview.discover_provider_models",
        lambda provider_id, config: [DiscoveredModel(provider_id, "current")],
    )
    monkeypatch.setattr(
        "runtime.validation.overview.ProviderValidationRunner.verify_models",
...
def test_regenerate_keeps_old_models_when_discovery_fails(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "runtime.validation.overview.discover_provider_models", fail_discovery
    )

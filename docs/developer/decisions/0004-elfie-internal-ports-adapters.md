# ADR-0004: Elfie internal Ports and Adapters
...
- bilingual contract indexes remain navigation documents rather than versioned
  contracts; governance still requires both indexes to change together.

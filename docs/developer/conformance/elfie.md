...
current implementation; real-workspace migration and external model/embodiment
acceptance remain separate gates. This register is not a second runtime

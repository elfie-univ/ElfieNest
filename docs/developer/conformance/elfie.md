...
| ELF-015 | P1 | open | The first bounded Recovery Motivation drive now has a Brain runtime owner and Lab evidence, but Cognitive Consolidation remains design-only; the aggregate active-autonomy/offline-growth capability is therefore not complete. | Implement bounded Motivation plus no-side-effect Cognitive Consolidation: fixed drives emit candidates with cooldown, and consolidation emits validated state candidates or later internal triggers under independent budgets. |

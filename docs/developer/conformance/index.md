...
- [Configuration management conformance](./configuration-management) — v0.2
  structural rows closed; future world-content review and real-workspace data
...
- [Elfie Selfhood conformance](./elfie-selfhood) — structural ownership rows
  closed; supported-model behavior and existing-workspace migration remain
  open under SHD-004 and SHD-007.

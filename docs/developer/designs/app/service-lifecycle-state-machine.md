...
> Design relations: **Owner:** App; **Parent:** whole-system design (separate parent; not relocated in this task);
> **Children:** none; **Normative contracts:** [Service lifecycle contract](../../contracts/service-lifecycle.md);
> **Current architecture:** [Runtime & data](../../architecture/runtime.md); **Conformance:**
> [Service lifecycle conformance](../../conformance/service-lifecycle.md); **Domain sources:** Product release journey.

...
> Design relations: **Owner:** Elfie; **Parent:** whole-system design (separate parent; not
> relocated in this task); **Children:** Brain, Embodiment, Communication and Genesis
> designs; **Normative contracts:** [System architecture contract](../../contracts/system.md);
> **Current architecture:** [Current architecture](../../architecture/); **Conformance:**
> [Conformance](../../conformance/); **Domain sources:** Product and Elfaria source identifiers.
...
[Selfhood design](./brain/elfie-selfhood-and-fixed-model-header.md) supersedes earlier

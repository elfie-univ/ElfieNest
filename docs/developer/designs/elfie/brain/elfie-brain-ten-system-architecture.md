...
> Design relations: **Owner:** Elfie / Brain; **Parent:** [Elfie top-level module
> design](../elfie-top-level-module-design.md); **Children:** Reasoning Core,
> Selfhood, Emotion, Memory and Brain evaluation; **Normative contracts:** [Brain
> contract](../../../contracts/brain.md); **Current architecture:** [Cognitive
> information flow](../../../architecture/cognitive-flow.md); **Conformance:**
> [Brain conformance](../../../conformance/), including scoped Emotion, Memory
> and Selfhood registers; **Domain sources:** Genesis owner-state inputs.

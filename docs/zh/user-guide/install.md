...
GitHub Workflow 产出的正式 macOS 安装包已经签名并公证。如果 macOS 仍提示安装包来自
身份不明的开发者，或者反复验证 ElfieNest 组件的临时副本，请停止安装。Windows 预览包
仍可能显示发布者警告。无论哪种情况，都应先确认文件来自官方 Releases 页面，不要为
来源不明的文件关闭系统安全设置。

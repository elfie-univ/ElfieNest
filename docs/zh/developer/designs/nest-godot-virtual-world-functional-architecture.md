...
> 领域基线：Elfie 产品、生命形态与世界资料
> 当前系统约束：[系统架构契约](../contracts/system.md)
> 规范性边界：[Nest–Godot 语义世界契约](../contracts/nest-godot-semantic-world.md)

> 设计关系：**所属模块：**Nest；**上级设计：**整个系统全局设计（独立的上级设计，本次未移动）；**下级设计：**无（当前单篇）；**规范性契约：**[系统架构契约](../contracts/system.md)、[Nest–Godot 语义世界契约](../contracts/nest-godot-semantic-world.md)；**当前架构：**[当前架构](../architecture/)；**一致性台账：**[Nest–Godot 语义世界一致性](../conformance/nest-godot-semantic-world.md)；**领域资料来源：**Elfie 产品与世界资料。

# Genesis 核心内核 v0.2 迁移执行计划（历史文档）

> **状态：** v0.2 功能迁移执行基线已冻结；当前设计入口已转为 Genesis v0.3
...
> **历史关系：** v0.1 是冻结历史，v0.2 是当时的直接迁移目标；本文是 v0.2 的历史执行记录，
> 不是 v0.3 的新执行计划，也不把多个版本变成多条可运行流水线。
